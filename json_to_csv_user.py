# -*- coding: utf-8 -*-
"""
Created on Fri Aug  7 17:20:03 2020
...
json_no = 0
for l in json_lines:
    root.writerow([l["user_id"], l["name"],l["review_count"],l["average_stars"],l["cool"],l["funny"],l["useful"],l["friends"],l["elite"],l["yelping_since"],l["fans"]])
    json_no += 1
